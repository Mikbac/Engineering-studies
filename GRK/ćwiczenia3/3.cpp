...
void renderScene()
{
	...
	/*czwarta kolumna*/
	transformation[3][0] = cos(time)*2;
	transformation[3][1] = cos(time)*2;
	transformation[3][2] = -cos(time)*2;
	...
	glUniform3f(glGetUniformLocation(program, "objectColor"), 0.333, sin(time), 0.333);
	...
	transformation[2][3] = 0;
	/*czwarta kolumna*/
	transformation[3][0] = -cos(time)*3;
	transformation[3][1] = -cos(time)*3;
	transformation[3][2] = -cos(time) * 3;
	transformation[3][3] = 1;
	...
	glUniformMatrix4fv(glGetUniformLocation(program, "transformation"), 1, GL_FALSE, (float*)&transformation);
	glUniform3f(glGetUniformLocation(program, "objectColor"), sin(time), 0.999, 0.999); // kolory w RGB
